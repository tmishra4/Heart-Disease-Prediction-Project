...
subsets.out$rss 
plot(round(sso$rss,2) , xlab = "Number of Variables" , ylab = "RSquare values", type = "l", 
main = "RSS Vs Number of Features Selection", col = "blue")
points(1:8, round(sso$rss,2), type="p", col = "red", pch=19)
